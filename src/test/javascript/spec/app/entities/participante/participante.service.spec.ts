...
import { IParticipante, Participante, EstadoParticipante } from 'app/shared/model/participante.model';
...
describe('Service Tests', () => {
    describe('Participante Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Participante(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 0, EstadoParticipante.ATIVO);
        });
