...
import com.coletaseletiva.api.repository.RedeSocialRepository;
...
import com.coletaseletiva.api.domain.enumeration.TipoRedeSocial;
/**
...
public class RedeSocialResourceIntTest {
    ...
    public static RedeSocial createEntity(EntityManager em) {
        ...
        em.flush();
        redeSocial.setParticipante(participante);
        return redeSocial;
    }
