...
import com.coletaseletiva.api.repository.EstadoRepository;
...
public class EstadoResourceIntTest {
    ...
    public void createEstado() throws Exception {
        ...
        assertThat(testEstado.getLatitude()).isEqualTo(DEFAULT_LATITUDE);
        assertThat(testEstado.getLongitude()).isEqualTo(DEFAULT_LONGITUDE);
    }
    ...
    public void updateEstado() throws Exception {
        ...
        assertThat(testEstado.getLatitude()).isEqualTo(UPDATED_LATITUDE);
        assertThat(testEstado.getLongitude()).isEqualTo(UPDATED_LONGITUDE);
    }
