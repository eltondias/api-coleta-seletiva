...
public class ProdutorResource {
    ...
    public ResponseEntity<Produtor> createProdutor(@Valid @RequestBody Produtor produtor) throws URISyntaxException {
    ...
    public ResponseEntity<Produtor> updateProdutor(@Valid @RequestBody Produtor produtor) throws URISyntaxException {
